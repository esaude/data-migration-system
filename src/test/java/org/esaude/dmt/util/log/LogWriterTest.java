...
private LogWriter writer;
	...
	public void testWriteInfoEvent() {
		...
		assertEquals("INFO at: VALID Tuple/Match: 1 MATCH_L_TO_R : 1 - The mapping must have a default value", log);
	...
	public void testWriteWarningEvent() {
		...
		assertEquals(
				"WARNING ERR001 at: VALID Tuple/Match: 1 MATCH_L_TO_R : 1 - The mapping must have a default value",
				log);
	...
	public void testWriteErrorEvent() {
		...
		assertEquals(
				"ERROR ERR001 at: VALID Tuple/Match: 1 MATCH_L_TO_R : 1 - The mapping must have a default value",
				log);
